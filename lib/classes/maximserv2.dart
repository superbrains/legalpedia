...
class Services{
  ...
  static const String url =   'https://resources.legalpediaresources.com/api/services/app/dictionary/getall';
  static Future<List<MaximList>> getMaxims() async{

    try{
      final response = await http.post(url,  headers: {'content-type' : 'application/json'}, body: jsonEncode({'MaxResultCount': 1143, 'SkipCount': 0, 'Title': ''}));
