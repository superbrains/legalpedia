class SummaryList{
  ...
  SummaryList({this.suitNo, this.title, this.summaryOfFacts, this.held, this.issues, this.casesCited, this.statusCited, this.legalpediaCitation, this.judgementDate,
  ...
  factory SummaryList.fromJson(Map<String, dynamic> json){
