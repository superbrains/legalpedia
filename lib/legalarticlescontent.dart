...
class LegalArticlesContent extends StatefulWidget{

  @override
  _LegalArticlesContent createState()=> _LegalArticlesContent();

}

class _LegalArticlesContent extends State<LegalArticlesContent>{
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(iconTheme: new IconThemeData(color: Colors.white),
        ...
        title: Text('Legal Articles Content', style: TextStyle(
            fontWeight:  FontWeight.bold,
            fontSize: 16.0,
      ...
      ListView(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 20,),
          Text(globals.selectedarticlesTitle, style: TextStyle(
            color: Colors.red,
            fontSize: 18,
            fontFamily: 'Monseratti',
            fontWeight: FontWeight.bold
           ...
           SizedBox(height: 20,),
          Html(
                              data: globals.selectedarticlesContent,
